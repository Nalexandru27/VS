...
class PriceDividendRatioEstimator:
    ...
    def get_priceDividend_ratio_estimation(self, start_year, end_year):
        ...
        last_dividendPayout_reported = self.stock.yf.cash_flow.loc['Cash Dividends Paid'].iloc[0]
        shares_outstanding = self.stock.yf.balance_sheet.loc['Ordinary Shares Number'].iloc[0]
        last_dividendPayout_per_share = last_dividendPayout_reported / shares_outstanding
        current_dividend_yield = last_dividendPayout_per_share / current_price 
