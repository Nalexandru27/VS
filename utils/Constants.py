...
FILLED_PRICE_HISTORY_FILE_PATH = "outData/filled_PriceHistory.csv"
...
CLEANED_PRICE_DAILY_FILE_PATH = "outData/CleanedPriceDaily.csv"
FILLED_DAILY_PRICE_FILE_PATH = "outData/FilledPriceDaily.csv"
